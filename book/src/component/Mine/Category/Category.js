    ...
    _deleteSectionRow = async (rowKey)=>{
        ...
        if (model.is_system == true) {
            ...
            if (index == 0) {
                ...
                await DeviceStorage.save(sysHasArr, SAVE.PIN_CATE_SYS_HAS_PAY)
                await DeviceStorage.save(sysRemoveArr, SAVE.PIN_CATE_SYS_REMOVE_PAY)
                await DeviceStorage.save(sysHasSyncedArr, SAVE.PIN_CATE_SYS_Has_PAY_SYNCED)
                await DeviceStorage.save(sysRemoveSyncedArr, SAVE.PIN_CATE_SYS_REMOVE_PAY_SYNCED)
